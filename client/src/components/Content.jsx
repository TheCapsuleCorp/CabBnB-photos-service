...
const Content = (props) => (
  <div className="parent">
    <Photo photoClass={'leftPhoto desktopPhotoBorder'} photoUrl={props.photos[0]} />
    <div className="rightPhotosContainer">
      <div className="rightTopPhotoContainer">
        <Photo photoClass={'rightTopLeftPhoto desktopPhotoBorder'} photoUrl={props.photos[1]} />
        <Photo photoClass={'rightTopRightPhoto desktopPhotoBorder'} photoUrl={props.photos[2]}>
      ...
      <div className="rightBottomPhotoContainer">
        <Photo photoClass={'rightBottomLeftPhoto desktopPhotoBorder'} photoUrl={props.photos[3]} />
        <Photo photoClass={'rightBottomRightPhoto desktopPhotoBorder'} photoUrl={props.photos[4]}>
