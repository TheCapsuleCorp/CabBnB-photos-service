  ...
  <div className="parent">
    ...
    <div className="rightPhotosContainer">
      <div className="rightTopPhotoContainer">
        <Photo photoClass={'rightTopLeftPhoto'} photo={props.photos[1]} />
      ...
      <div className="rightBottomPhotoContainer">
        <Photo photoClass={'rightBottomLeftPhoto'} photo={props.photos[3]} />
        <Photo photoClass={'rightBottomRightPhoto'} photo={props.photos[4]}>
